      ...
      *>
       ...
       01  IF-D35.
           ...
           88  BB1    VALUE "B".
           88  BB2 VALUE "D".
       01  IF-D36  PICTURE X(120) VALUE IS    "ABCDEFGHIJKLMNOPQRSTUVWXY
      -    "Z1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890ABCDEFGHIJKLM
      -    "NOPQRSTUVWXYZ1234567890ABCDEFGHIJKL".
       ...
       01  CCVS-C-1.
           02 FILLER  PIC IS X(99)    VALUE IS " FEATURE              PA
      -    "SS  PARAGRAPH-NAME
      -    "       REMARKS".
      ...
      *>   NOTE TABLE-86 (   ABC) SHOULD EQUAL C86 (   ABC).
       ...
       IF-WRITE-123.
           ...
           PERFORM PRINT-DETAIL.
           PERFORM END-ROUTINE.
           MOVE    " COLLATING-AND-ALPHABET-TEST-9  SYNTAX CHECK IN OBJE
      -    "CT-COMPUTER AND SPECIAL-NAMES" TO TEST-RESULTS.
           PERFORM PRINT-DETAIL.
           MOVE SPACE TO TEST-RESULTS.
       IF-INIT-124.
