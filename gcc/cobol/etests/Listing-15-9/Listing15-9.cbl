...
PROCEDURE DIVISION.
Begin.
        *> eg1. In the EBCDIC collating sequence W has a code of 230 but an ordinal
        *> position of 231.
        DISPLAY "eg1. The character in position 231 is = " FUNCTION CHAR(231)

     *> eg2. Using ordinal positions to spell out my name
        DISPLAY SPACES
        DISPLAY "eg2. My name is " FUNCTION CHAR(213)  FUNCTION CHAR(138)
                                   FUNCTION CHAR(147) FUNCTION CHAR(134)
