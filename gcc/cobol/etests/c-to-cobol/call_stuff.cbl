...
PROCEDURE DIVISION.
    ...
    CALL    "_to_ctype" using USR-LOCAL-BIN by value length of USR-LOCAL-BIN
    CALL    "chdir"
    ...
    CALL    "_from_ctype" using CWD by value length of CWD
    DISPLAY "CWD is '" CWD "'"
    DISPLAY SPACES
    ...
    CALL    "_from_ctype" using CWD by value length of CWD
    CALL    "_from_ctype" using RETURNED-CWD by value length of RETURNED-CWD
    DISPLAY "CWD is '" CWD "'"
...
PROCEDURE DIVISION.
    ...
    CALL "_to_ctype" using string-integer by value length of string-integer
    CALL "string_to_long"
    ...
    CALL "_from_ctype" using string-integer by value length of string-integer
