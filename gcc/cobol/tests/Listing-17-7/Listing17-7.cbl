...
DeleteFilmRec.
    ...
    DISPLAY "About to DELETE " FilmId-FF
...
*To preserve Referential Integrity check director exists for this Film
    ...
    IF MatchingDirectorFound
       ...
       DISPLAY "About to INSERT/WRITE " FilmRec-FF
       WRITE FilmRec-FF
...
UpdateFilmRec.
    MOVE FilmId-TF TO FilmId-FF
    DISPLAY "About to UPDATE/READ '" FilmId-FF "'"
    ...
    IF FilmOk
       ...
       DISPLAY "About to REWRITE '" FilmRec-FF "'"
       REWRITE FilmRec-FF
...
BuildDirectorFile.
    OPEN OUTPUT DirectorsFile
    MOVE "002Tarantino           " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "003Zucker              " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "004Marshall            " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "005Spielberg           " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "009Jackson             " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "012Weir                " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "015De Palma            " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "023Scott               " TO DirectorsRec-DF WRITE FILE DirectorsFile
    MOVE "033Scorsese            " TO DirectorsRec-DF WRITE FILE DirectorsFile
    CLOSE DirectorsFile.
