...
package Sinfo is
   ...
   --  Wraps_Return
   --    This flag is set for block statements that wrap return statements
   --    inside a parallel scope. This is done so that expanded return
   --    statements can be rewritten as calls to LWT.
